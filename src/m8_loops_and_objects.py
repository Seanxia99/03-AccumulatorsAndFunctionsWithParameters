...
def main():
    ...
    # Test your functions by putting calls to them here: def test_print_sequence1():
...
def draw_circles2():
    ...
    for k in range(21):
        ball = 50 + 20 * k
        center_point = rg.Point(ball, 100)
...
def run_test_print_sequence3():
    ...
    expected = 1
    answer = print_sequence3(1)
    print('       expected', expected)
    print('       actual', answer)

    expected = 2
    answer = print_sequence3(2)
    print('       expected', expected)
    print('       actual', answer)

    expected = 3
    answer = print_sequence3(3)
    print('       expected', expected)
    print('       actual', answer)
